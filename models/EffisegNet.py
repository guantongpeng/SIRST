...
class EffiSegNet(nn.Module):
    def __init__(
        ...
        super(EffiSegNet, self).__init__()
        ...
        self.up4 = nn.Upsample(scale_factor=16, mode="nearest")
        self.up5 = nn.Upsample(scale_factor=32, mode="nearest")
