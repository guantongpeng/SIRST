...
class res_UNet(nn.Module):
    ...
    def __init__(self, num_classes, input_channels, block, num_blocks,
                 nb_filter):
        ...
        self.conv2_1 = self._make_layer(block, nb_filter[2] + nb_filter[3],
                                        nb_filter[2])
        self.conv1_2 = self._make_layer(block, nb_filter[1] + nb_filter[2],
                                        nb_filter[1])
        self.conv0_3 = self._make_layer(block, nb_filter[0] + nb_filter[1],
                                        nb_filter[0])
